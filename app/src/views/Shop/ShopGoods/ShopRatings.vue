	...
	<div class="ratings" ref="ratings">
		<div class="ratings-content">
			...
			<div class="ratingselect">
				...
				<div @click="toggleOnlyContent" class="switch" :class="{on: onlyContent}">
		...
		filterRatings () {
			...
			return ratings.filter(rating => {
				if (this.selectType === 2) {
					return !this.onlyContent || rating.text.length > 0
				} else {
					return rating.rateType === this.selectType && (!this.onlyContent || rating.text.length > 0)
				}
			})
		},
		positiveNum () {
